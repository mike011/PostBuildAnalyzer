...
class FileWarningTests: XCTestCase {
    ...
    func testGetFileName() {
        let warning = FileWarningModel(repoURL: "", branch: "", firstLine: "Documents/git/PostBuildAnalyzer/example/Before/Example/ExistingClassCovered.swift:15:26: warning: 'index(of:)' is deprecated")
    ...
    func testWarningWithNoLineNumbers() {
        let warning = FileWarningModel(repoURL: "https://github.com/mike011/PostBuildAnalyzer", branch: "master", firstLine: "/Users/distiller/project/application/Frank/Bob/Core Data/ILDRates.xcdatamodeld/ILDRates 8.15.0.xcdatamodel:TMORate.dialCodes: warning: TMORate.dialCodes does not have an inverse")
...
//        let warning = FileWarningModel(repoURL: "https://github.com/mike011/PostBuildAnalyzer", branch: "master", firstLine: "/Users/distiller/project/application/Frank/Bob/Core Data/ILDRates.xcdatamodeld/ILDRates 8.15.0.xcdatamodel:TMORate.dialCodes: warning: TMORate.dialCodes does not have an inverse")
//
//        let warning2 = FileWarningModel(repoURL: "https://github.com/mike011/PostBuildAnalyzer", branch: "master", firstLine: "/Users/distiller/project/application/Frank/Bob/Core Data/ILDRates.xcdatamodeld/ILDRates 8.15.0.xcdatamodel:TMORate.dialCodes: warning: TMORate.dialCodes does not have an inverse")
//
...
//        let warning = FileWarningModel(repoURL: "https://github.com/mike011/PostBuildAnalyzer", branch: "master", firstLine: "/Users/distiller/project/application/Frank/Bob/Core Data/ILDRates.xcdatamodeld/ILDRates 8.15.0.xcdatamodel:TMORate.dialCodes: warning: TMORate.dialCodes does not have an inverse")
//
//        let warning2 = FileWarningModel(repoURL: "https://github.com/mike011/PostBuildAnalyzer", branch: "master", firstLine: "/Users/distiller/project/application/Frank/Core Data/ILDRates.xcdatamodeld/ILDRates 8.15.0.xcdatamodel:TMORate.dialCodes: warning: TMORate.dialCodes does not have an inverse")
//
